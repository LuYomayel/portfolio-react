...
function Footer() {
    return (
        <footer>
            <a className="skill-icon" href="https://www.linkedin.com/in/luciano-yomayel">
            ...
            <a className="skill-icon" href="https://www.github.com/luyomayel">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
            ...
            <p>Contact: l.yomayel@gmail.com</p>
        </footer>
    );
}
